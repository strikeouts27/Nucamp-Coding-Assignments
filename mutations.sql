...
-- Create a table to show what categories each employee is an expert in. 

-- A: id's for categories and id's for employee.
-- column for number of categories and employee is an expert in.

-- Q: What type of relationship is this? (many-to-many?)
-- Can employees be experts in more than one category? Yes. 
-- Can there be multiple employees that can be experts in a single category? Yes
